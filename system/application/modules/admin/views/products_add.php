        ...
        <div class="col-md-12">
            <div class="ibox-content profile-content">
                <div class="panel panel-primary">
                    ...
                    <form class="form-horizontal" id="product_add" method="post" action="<?php echo base_url(); ?>admin/products_add/add" enctype="multipart/form-data">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9"><input class="form-control" name="name" placeholder="Product Name"></div>
                        </div>
                        <div class="form-group">
